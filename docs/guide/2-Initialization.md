...
For *Stremio* proceed directly [below](#️-stremio), for *Nuvio* scroll further [down](#-nuvio).
...
3. Go to "**Settings**" in [**Stremio Account**](https://www.stremio.com) and enable **Trakt Scrobbling** by connecting it to your Trakt account.
   * *This will allow Stremio to sync show progress and history with Trakt.*

   ![Trakt Scrobbling](../images/2.3.png)

4. Go to "**Addons**" and uninstall all addons.
